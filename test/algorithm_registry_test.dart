  ...
  group('AlgorithmRegistry', () {
    ...
    test('matches standard digest vectors', () {
      final vectors = <String, String>{
        ...
        'sha3-256': '3a985da74fe225b2045c172d6bd390bd855f0863e9d525b46bfe24511431532',
        'blake2b-512': 'ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d'
            '17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923',
      };
      for (final entry in vectors.entries) {
        expect(registry.digestBytes(entry.key, abc), entry.value, reason: entry.key);
      }
    });
    ...
    test('registers an explicit custom implementation', () {
      ...
      final customRegistry = AlgorithmRegistry(customAlgorithms: const <CustomHashAlgorithm>[custom]);
      expect(customRegistry.descriptor('company-hash').status, AlgorithmStatus.custom);
